...
?>
	<table class="tdbgcl" width="100%"  border="0" cellpadding="0">
      <tr class="tdbgcl">
        <td>
		<h2>Expedia Sync Configuration</h2>
		</td>
      </tr>
      <tr class="tdbgcl">
        <td><div id="Requests">
				  ...
				  <?php 
				  	if(file_exists(dirname(__FILE__)."/OTA/Expedia/libs/expediaconf.php")){
				  		include_once(dirname(__FILE__)."/OTA/Expedia/libs/expediaconf.php");
				  	} else { ?>
				  		<table>
					  		<tr>
