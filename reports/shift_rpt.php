...
?>
       <table height="500" class="listing-table">	        
	       <tbody>
	 		...
	 		?> 
	          <td valign="top">  
	          <?php if((is_ebridgeCustomer() && accessNew('reports')) || (is_ebridgeCustomer() && $menu=='myShift')){ 
				...
				<table width=100%>
					...
					<td>	
						...
						<tr>							
							...
							<h2><?php echo $_L['RT_shiftrpt']; ?></h2><?php echo  $_L['RT_shiftfull'];?><br/><br/><b><?php echo  $_L['RT_hotelguestprev'];?></b>
								<ul class="enlarge">								
									<li><img src="reports/images/hotel_shift_report_screen.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_shift_report_screen.jpg" alt="Image" /><br /><b>Shift Report/Maintenance Screen Shot</b></span></li>
									<li><img src="reports/images/hotel_shift_report.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_shift_report.jpg" alt="Image" /><br /><b>Shift Report/Maintenance Spreadsheet</b></span></li>						
								</ul>
							</td>						
						</tr>
						</table>	
