	       ...
	       <tbody>
	 		...
	 		<?php print_rightMenu_reports();?> 
	          ...
	          <?php if(is_ebridgeCustomer() && accessNew('reports')){ 
	          	include(dirname(__FILE__)."/../OTA/reports/hotel_tourism_rpt.php");	          	
	          } else {?>
				...
				<table width=100%>
					...
					<td>	
						...
						<tr>							
							...
							<h2><?php echo $_L['RT_tourismreport']; ?></h2><?php echo  $_L['RT_tourismdescfull'];?><br/><br/><b><?php echo  $_L['RT_hotelguestprev'];?></b>
								<ul class="enlarge">								
									<li><img src="reports/images/hotel_tourism_report_screen.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_tourism_report_screen.jpg" alt="Image" /><br /><b>Tourism Report Screen Shot</b></span></li>
									<li><img src="reports/images/hotel_tourism_report.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_tourism_report.jpg" alt="Image" /><br /><b>Tourism Report Spreadsheet</b></span></li>						
								</ul>
							</td>						
						</tr>
						</table>	
