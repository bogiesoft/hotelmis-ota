				...
				<table width=100%>
					...
					<td>	
						...
						<tr>							
							...
							<h2><?php echo $_L['RT_Receiptrpt']; ?></h2><?php echo  $_L['RT_Receiptdescfull'];?><br/><br/><b><?php echo  $_L['RT_hotelguestprev'];?></b>
								<ul class="enlarge">								
									<li><img src="reports/images/hotel_receipt_report_screen.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_receipt_report_screen.jpg" alt="Image" /><br /><b>Receipt Inventory Report Screen Shot</b></span></li>
									<li><img src="reports/images/hotel_receipt_report.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_receipt_report.jpg" alt="Image" /><br /><b>Receipt Inventory Report Spreadsheet</b></span></li>														
								</ul>
							</td>						
						</tr>
						</table>	
