	       ...
	       <tbody>
	 		...
	 		<?php print_rightMenu_reports();?> 
	          ...
	          <?php if(is_ebridgeCustomer() && accessNew('reports')){ 
	          	include(dirname(__FILE__)."/../OTA/reports/hotel_tax_rpt.php");	          	
	          } else {?> 
				...
				<table width=100%>
					...
					<td>	
						...
						<tr>							
							...
							<h2><?php echo $_L['RT_taxreport']; ?></h2><?php echo  $_L['RT_taxdescfull'];?><br/><br/><b><?php echo  $_L['RT_hotelguestprev'];?></b>
								<ul class="enlarge">								
									<li><img src="reports/images/hotel_tax_rpt_screen.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_tax_rpt_screen.jpg" alt="Image" /><br /><b>Tax Report Screen Shot</b></span></li>
									<li><img src="reports/images/hotel_tax_rpt.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_tax_rpt.jpg" alt="Image" /><br /><b>Tax Report Spreadsheet</b></span></li>						
								</ul>
							</td>						
						</tr>
						</table>	
