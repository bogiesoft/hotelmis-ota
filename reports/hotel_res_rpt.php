	       ...
	       <tbody>
	 		...
	 		<?php print_rightMenu_reports();?> 
	          ...
	          <?php if(is_ebridgeCustomer() && accessNew('reports')){ 
	          	include(dirname(__FILE__)."/../OTA/reports/hotel_res_rpt.php");	          	
	          } else {?> 
				...
				<table width=100%>					
					...
					<td>	
						...
						<tr>							
							...
							<h2><?php echo $_L['RT_ResReport']; ?></h2><?php echo  $_L['RT_hotelguestdescfull'];?><br/><br/><b><?php echo  $_L['RT_hotelguestprev'];?></b>
								<ul class="enlarge">								
									<li><img src="reports/images/hotel_res_report_screen.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_res_report_screen.jpg" alt="Image" /><br /><b>Guest Report Screen Shot</b></span></li>
									<li><img src="reports/images/hotel_res_report.jpg" width="100px" height="100px" alt="Image" /><span><img  width="" height="" src="reports/images/hotel_res_report.jpg" alt="Image" /><br /><b>Guest Report Spreadsheet</b></span></li>						
								</ul>
							</td>						
						</tr>
						</table>	
